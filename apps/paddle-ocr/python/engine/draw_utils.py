...
from .utils import resize_img, get_minarea_rect, V6_FONT_DIR
...
def make_right_display_image(image, bboxes, texts, font_path=None, use_precise_transform=True):
    ...
    if font_path is None:
        font_path = str(V6_FONT_DIR / "NotoSansCJK-Regular.ttc")
...
def text_visual(
    ...
    img_w=600,
    threshold=0.0,
    font_path=str(V6_FONT_DIR / "NotoSansJP-VariableFont_wght.ttf"),
):
    """
